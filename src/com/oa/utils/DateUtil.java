...
public class DateUtil {
	...
	public static String getLastWeekDay(java.util.Date theDate) {
		...
		calendar.setFirstDayOfWeek(Calendar.MONDAY);
		calendar.set(Calendar.DAY_OF_WEEK, Calendar.MONDAY);
		return DateUtil.format(new Date(calendar.getTime().getTime() + (6 * 24 * 60 * 60 * 1000)), "yyyy-MM-dd")
				+ " 23:59:59";
	}
	 ...
	 */
	@SuppressWarnings("unused")
	public static Date getUpMonth(java.util.Date theDate, int month) throws ParseException {
	...
	public static void main(String[] args) throws Exception {
		List<Date> days = DateUtil.getDatesBetweenTwoDate(DateUtil.getdate("2013-01-09"),
				DateUtil.getdate("2013-01-11"));
